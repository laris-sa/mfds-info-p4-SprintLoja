...
import criarContaFuncionario.CriarContaFuncionario;
	...
	public class Principal {
	    ...
	    public static void criarConta() {
	        CriarConta criarConta = new CriarConta();  // Cria um objeto da classe CriarConta
	        criarConta.criarContaCliente();  // Chama o método "criarContaCliente" da classe CriarConta
	    ...
	    public static void criarContaFuncionario() {
	        ...
	        criarContaFuncionario.criarContaFuncionario(); // Chama o método "criarContaFuncionario" da classe CriarContaFuncionario
